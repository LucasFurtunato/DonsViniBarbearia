...
function enviarEmailConfirmacao($email, $nome, $token) {
    try {
        ...
        $message = "Olá,$nome<br><br>Por favor, clique no link abaixo para confirmar seu e-mail:<br><br>
...
function enviarCodRecuperacaoSenha($email, $nome, $token) {
    try {
        ...
        $message = "Olá,<br><br>Por favor, use o código abaixo para recuperar sua senha:<br><br>
