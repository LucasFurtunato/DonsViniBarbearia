    ...
    <header>
        <nav>
            ...
            <ul class="nav-list">
                ...
                <li class="login-item">
                    <a href="#" class="login-button" id="aName"></a>
                    <a href="#" class="login-button" id="aEntrar">Entrar</a>

                    <div class="login-submenu">
                        <a href="#" id="aAgenda">Agenda</a>
                        <a href="../app/controllers/logout.php" id="aSair">Sair</a>
    ...
    <main>
        ...
        <section id="services">
            ...
            <div class="services-container">
                ...
                <div class="card">
                    <div class="card-content">
                        <img src="assets/img/navalha.png" alt="Navalha">
                        <h3>Barba</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <img src="assets/img/pincel.png" alt="Pincel">
                        <h3>Cuidados</h3>
                        <div class="line"></div>
            ...
            <div class="gallery-content">
                <div class="wrapper">
                    ...
                    <div class="carousel">
                        ...
                        <img src="assets/img/image5.jpg" alt="" draggable="false">
                        <img src="assets/img/image6.jpg" alt="" draggable="false">
                        <img src="assets/img/image7.jpg" alt="" draggable="false">
                        <img src="assets/img/image8.jpg" alt="" draggable="false">
                        <img src="assets/img/image9.jpg" alt="" draggable="false">
                        <img src="assets/img/image10.jpg" alt="" draggable="false">
                        <img src="assets/img/image11.jpg" alt="" draggable="false">
                        <img src="assets/img/image12.jpg" alt="" draggable="false">
                    </div>
        ...
        <section id="contact">
            ...
            <div class="contact-container">
                <div class="square square1">
                    <img src="assets/img/barber-contact.jpeg" alt="Ilustração de barbeiro">
                </div>
