...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="assets/css/index_main_admin.css">
...
<body>
    ...
    <main>
        <div class="background-container">
            <a href="#" class="button">Editar Imagem</a>
            <h1>Don' Vini</h1>
            <h2>Barbearias</h2>
        </div>
        ...
        <section id="about">
            ...
            <a href="#" class="button-generic">Editar Texto</a>
        ...
        <section id="services">
            ...
            <a href="#" class="button-generic red">Editar</a>
